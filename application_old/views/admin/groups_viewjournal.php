...
<div class="row">    
    <div class="col-xm-12 col-sm-2">
        <div class="info-left">
            <img src="<?php echo getProfileLink($child['id_child']) ?>" width="80px" height="80px"> 
    ...
    <div class="col-xm-12 col-sm-10">
        ...
        if(isset($child['events']) && is_array($child['events']))
            ...
            {                
                $events[date_format(new Datetime($event->datetime_start), 'Gi')] = $event;
            }
        ?>
                    ...
                    <div class="min-outer-wrapper <?php if($min_w == 0) echo 'hour_start' ?> " id="5_<?php echo $hr_w.'_'.$min_w ?>">
                        ...
                        ?>
                            ...
                            <?php
                                ...
                                if($k_row >= $cursor && $k_row < $cursor+5):
